 ...
 */
export abstract class BasePostProcessingPipelineElement<
    TRequestModel,
 ...
 * @typeparam TDTO The type of the data transfer object for the use case.
 */
export abstract class BaseStreamingPostProcessingPipelineElement<
    TRequestModel,
    TResponseModel extends BaseResponseModel,
    TErrorModel extends BaseErrorResponseModel,
    TDTO extends BaseDTO,
> extends Transform {
    ...
    async _transform(
        ...
        callback: (error?: Error | null, data?: any | TErrorModel) => void,
    ): Promise<void> {
 ...
 */
export class BaseFinalResponseModelValidatorPipelineElement<
    TResponseModel extends BaseResponseModel,
    TErrorModel extends BaseErrorResponseModel,
> extends Transform {
